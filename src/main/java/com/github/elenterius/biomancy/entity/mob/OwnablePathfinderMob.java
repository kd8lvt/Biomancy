...
public abstract class OwnablePathfinderMob extends PathfinderMob implements OwnableMob {

	protected static final EntityDataAccessor<Optional<UUID>> OWNER_UNIQUE_ID = SynchedEntityData.defineId(OwnablePathfinderMob.class, EntityDataSerializers.OPTIONAL_UUID);
